...
###
module.exports =  mongoose.model "qtask_user", (mongoose.Schema
  user:
  ...
  status:
    type    : String
    enum    : ['INACTIVE', 'CONNECTED','ACTIVE', 'INTRO','IN_WORKOUT', 'DISCONNECTED', 'PING','PING_1', 'PING_2', 'PING_3','REMOVED']
    default : "INACTIVE"
    required: true
